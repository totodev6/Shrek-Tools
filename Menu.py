...
def search_for_updates():
    ctypes.windll.kernel32.SetConsoleTitleW("Tools Updater | Made by Shrek™")
    clear()

    # Faire la requête vers la page GitHub
    r = requests.get("https://github.com/blackray207/Shrek_Multi_Tools-BETA/releases/latest")

    # Parser le contenu HTML avec BeautifulSoup
    soup = BeautifulSoup(r.text, 'html.parser')

    # Utiliser un sélecteur CSS alternatif
    title_tag = soup.select_one('head title')

    # Vérifier si la balise de titre a été trouvée
    if title_tag:
        title_text = title_tag.get_text()
        # Traiter title_text selon vos besoins
    else:
        print("Impossible de trouver la balise de titre sur la page.")
        return
...
░ ░░   ░ ▒░░ ░ ░    ▒ ░ ░      ░░▒░ ░ ░ ░▒ ░      ░ ▒  ▒ ░ ░   ▒▒     ░    ░ ░ ░  
   ░   ░ ░     ░    ░   ░       ░░░ ░ ░ ░░        ░ ░  ░   ░   ▒    ░          ░  
         ░ ░   ░      ░           ░                 ░          ░           ░   ░  
            ...
            """)
        print(f''' [{lr}!{w}] Shrek_Multi_Tools [{m}{THIS_VERSION}{w}] is OUTDATED''')
        ...
        if choice.lower() == 'y' or choice.lower() == 'yes':
            print(f" [{g}#{w}] Updating Shrek_Multi_Tools...")
            ...
            if os.path.basename(sys.argv[0]).endswith("exe"):
                ...
                with ZipFile("Shrek-multi-tools-main.zip", 'r') as filezip:
                    filezip.extractall()
                os.remove("Shrek-multi-tools-main.zip")
                cwd = os.getcwd()+'\\Shrek-muti-tools-main'
...
{Fore.LIGHTGREEN_EX}                                                 ░    ░  ░  ░   ░        ░   ░  ░   
    ...
    print(Fore.GREEN + '                 ╔══════════════════════════════╦══════════════════════════╦══════════════════════════════╗')
    print(Fore.GREEN +f'                 ║     {Fore.LIGHTGREEN_EX}  NUKERS & RAIDERS       {Fore.GREEN}║     {Fore.LIGHTGREEN_EX}    GENERATORS       {Fore.GREEN}║         {Fore.LIGHTGREEN_EX}MORE OPTIONS         {Fore.GREEN}║')
    print(Fore.GREEN +f'                 ╠══════════════════════════════╬══════════════════════════╬══════════════════════════════╣')
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}01{Fore.GREEN}] {Fore.WHITE}TOKEN NUKERS        {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}10{Fore.GREEN}] {Fore.WHITE}TOKEN GEN       {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}18{Fore.GREEN}] {Fore.WHITE}TOKEN BRUTE-FORCER  {Fore.GREEN}║')
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}02{Fore.GREEN}] {Fore.WHITE}TOKEN JOINER        {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}11{Fore.GREEN}] {Fore.WHITE}NITRO GEN       {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}19{Fore.GREEN}] {Fore.WHITE}TOKEN CHECKER       {Fore.GREEN}║')
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}03{Fore.GREEN}] {Fore.WHITE}TOKEN LEAVER        {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}12{Fore.GREEN}] {Fore.WHITE}PROXY GEN       {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}20{Fore.GREEN}] {Fore.WHITE}TOKEN LOGIN         {Fore.GREEN}║')
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}04{Fore.GREEN}] {Fore.WHITE}TOKEN ONLINER       {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}13{Fore.GREEN}] {Fore.WHITE}GRABBER GEN     {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}21{Fore.GREEN}] {Fore.WHITE}TOKEN INFO          {Fore.GREEN}║')
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}05{Fore.GREEN}] {Fore.WHITE}WEBHOOK RAIDER      {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}14{Fore.GREEN}] {Fore.WHITE}QR GRABBER GEN  {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}22{Fore.GREEN}] {Fore.WHITE}PFP CHANGER         {Fore.GREEN}║')
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}06{Fore.GREEN}] {Fore.WHITE}SERVER NUKER       {Fore.GREEN} ║     {Fore.GREEN}[{Fore.WHITE}15{Fore.GREEN}] {Fore.WHITE}RAT BOT GEN     {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}23{Fore.GREEN}] {Fore.WHITE}HYPEQUAD CHANGER   {Fore.GREEN} ║')
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}07{Fore.GREEN}] {Fore.WHITE}SERVER SPAMMER      {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}16{Fore.GREEN}] {Fore.WHITE}ID GEN          {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}24{Fore.GREEN}] {Fore.WHITE}BIO CHANGER         {Fore.GREEN}║')
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}08{Fore.GREEN}] {Fore.WHITE}FRIEND SPAMMER      {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}17{Fore.GREEN}] {Fore.WHITE}NAME GEN        {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}25{Fore.GREEN}] {Fore.WHITE}ID TO TOKEN     {Fore.GREEN}    ║')
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}09{Fore.GREEN}] {Fore.WHITE}DDOS ATTACKER       {Fore.GREEN}║                          ║     {Fore.GREEN}[{Fore.WHITE}26{Fore.GREEN}] {Fore.WHITE}MASE REPORT     {Fore.GREEN}    ║')
    print(Fore.GREEN + '                 ╚══════════════════════════════╩══════════════════════════╩══════════════════════════════╝')
    print(Fore.GREEN + '')
    print(Fore.GREEN + '')
    print(Fore.GREEN + '')
...
░ ▓██▓ ░ ▒██   ██░ ▓██ █▄ ▒▓█  ▄▓██▒  ▐▌██▒     ░██▓██▒  ▐▌██▒ ░▓█▒   ▒██   ██░
  ...
  ░ ░    ░ ░ ░ ▒   ░ ░░ ░    ░     ░   ░ ░       ▒    ░   ░ ░   ░ ░   ░ ░ ░ ▒  
    ...
    cls()
    print(Fore.RESET)
    print(f'User Id: {Fore.WHITE}{r.json()["id"]}')
    print(f'{Fore.RESET}Full Name: {Fore.WHITE}{r.json()["username"]}#{r.json()["discriminator"]}')
    print(f'{Fore.RESET}Number Of Friends + Friend Requests: {Fore.WHITE}{numoffriend}')
    print(f'{Fore.RESET}Number Of Servers: {Fore.WHITE}{numofguilds}')
    pf = r.json()["avatar"]
    id = r.json()["id"]
    pfp = f'https://cdn.discordapp.com/avatars/{id}/{pf}'

    print(f'{Fore.RESET}Profile Picture: {Fore.WHITE}{pfp}')
    if r.json()['banner'] == 'null':
        print(f'{Fore.RESET}Banner:{Fore.WHITE} None')
    else:
        banner = f'https://cdn.discordapp.com/banners/{r.json()["id"]}/{r.json()["banner"]}'
        print(f'{Fore.RESET}Banner: {Fore.WHITE}{banner}')
    print(f'{Fore.RESET}Bio: {Fore.WHITE}{r.json()["bio"]}')
    print(f'{Fore.RESET}Language: {Fore.WHITE}{r.json()["locale"]}')
    print(f'{Fore.RESET}Email: {Fore.WHITE}{r.json()["email"]}')
    print(f'{Fore.RESET}2fa: {Fore.WHITE}{r.json()["mfa_enabled"]}')
    print(f'{Fore.RESET}Email Verifed: {Fore.WHITE}{r.json()["verified"]}')
    if r.json()['phone'] == 'null' or 'Null' or 'None' or '':
        print(f'{Fore.RESET}Phone Verification:{Fore.RED} False')
    else:
        print(f'{Fore.RESET}Phone Verification:{Fore.WHITE} True')
    print(f'{Fore.RESET}Public Flags: {Fore.WHITE}{r.json()["public_flags"]}')

    settings = 'https://discord.com/api/v9/users/@me/settings'
    t = requests.get(settings, headers=header)
    print(f'{Fore.RESET}Custom Status: {Fore.WHITE}{t.json()["custom_status"]}')
    print(f'{Fore.RESET}Status: {Fore.WHITE}{t.json()["status"]}')
...
{Fore.GREEN}                                                    
    ''')
    global id_to_token
    id_to_token = base64.b64encode((input(f'''{Fore.GREEN}[{Fore.WHITE}+{Fore.GREEN}] {Fore.WHITE} What is the User's ID?: ''')).encode("ascii"))
